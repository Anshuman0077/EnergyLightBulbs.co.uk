...
<section className="w-full px-4">
  <div className="min-h-screen w-full md:mt-4 mt-2 grid grid-cols-1 md:grid-cols-12 gap-6 text-text18">
    {/* Registered Customers (Left Column) */}
    <div className="md:col-span-5 col-span-1 w-full">
      <h1 className="text-2xl font-medium md:mb-6 mb-4 text-text17">REGISTERED CUSTOMERS</h1>
      <p className="text-sm mb-6">If you have an account, sign in with your email address.</p>
      ...
      <div className="flex flex-col w-full">
        <div className="relative inline-block group w-full md:w-1/4 mt-12 max-w-xs">
    ...
    <div className="md:col-span-6 col-span-1 rounded-md w-full">
      ...
      <div className="relative inline-block group w-full sm:w-fit max-w-xs">
