...
export const buyersGuideLedContentData: BuyerGuideData = {
  ...
  sections: [
    ...
    },
    {
      ...
      content: ['As last, robust LEDs with superb life rates of up to 30,000 - 50,000 hours have arrived.'],
    },
    {
    ...
    {
      heading: 'WHICH DRIVER AND WHICH LED?',
      content: [
    ...
    {
      heading: 'COMMERCIAL ENVIRONMENTS - LEDS',
      content: [
