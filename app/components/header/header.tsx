          ...
          <div className="flex w-full md:w-[68%] flex-col min-w-0">
            ...
            <div className="flex w-full items-center flex-wrap gap-x-4 gap-y-2 max-[949px]:justify-start min-[950px]:justify-end">
              ...
              <div className="flex  items-center space-x-3 mt-2.5 mx-3 z-[60] relative ">
                ...
                <div className="relative md:flex mx-3 hidden " ref={basketRef}>
                  ...
                  {showBasket && (
                    <div
                      className={`absolute top-full z-50 mt-2 rounded-md border border-gray-300 shadow-md bg-white w-[95vw] max-w-md md:w-96 md:right-0 md:left-auto left-1/2 -translate-x-1/2 md:translate-x-0`}
                    >
                      {/* Arrow on desktop */}
                      <div
            ...
            <div className="w-full px-4 space-x-3 flex justify-start md:justify-end py-0 bg-gray-600 md:bg-white transition-colors duration-300 ">
              <div className="relative w-full max-w-xl  md:mt-4 mt-0 ">
                ...
                <div className="sm:px-6 md:px-0   md:py-0 sm:py-2 max-sm:py-2 mr-4 ">
                  <Input
                    ...
                    className="w-full md:py-3 py-0 text-xs   sm:rounded-tl-md sm:rounded-bl-md md:rounded-none max-sm:rounded-tl-md  max-sm:rounded-bl-md   border border-border4 text-text4 bg-white shadow-sm placeholder:font-bold  focus:outline-none"
                    label=""
                  />

                  <IoSearch
                    size={20}
                    className="absolute sm:right-0 md:right-6  max-sm:right-0 top-1/2 -translate-y-1/2  transition-colors duration-300 "
                  />
                </div>
              </div>
              <div
              ...
              >
                ...
                {showBasket && (
                  <div
                    className={`absolute top-full z-50  rounded-md border border-gray-300 shadow-md bg-white w-[95vw] max-w-md md:w-96 md:right-0 md:left-auto left-1/2  -translate-x-96`}
                  >
                    {/* Arrow on desktop */}
                    <div
                      className={`md:block absolute -top-2 right-5 w-4 h-4 bg-white rotate-45 border-l border-t border-gray-300`}
                    ></div>
